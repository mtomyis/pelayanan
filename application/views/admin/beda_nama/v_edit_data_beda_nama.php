      ...
      <div class="row">
        ...
        <!-- general form elements -->
            <div class="card card-primary">
              <!-- form start -->
              <form role="form" action="<?php echo base_url('C_beda_nama/simpanedit') ?>" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">NIK</label>
                    <input name="dataid_beda_nama" type="hidden" class="form-control" id="exampleInputPassword1" value="<?php echo $data_penduduk->id_beda_nama ?>" >
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Nama Baru</label>
                    <input name="datanama" type="text" class="form-control" id="exampleInputPassword1" placeholder="Nama" required value="<?php echo $data_penduduk->nama_baru ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Maksud Pembuatan</label>
                    <input name="a" type="text" class="form-control" id="exampleInputPassword1" placeholder="Maksud Pembuatan" required value="<?php echo $data_penduduk->maksud_pembuatan ?>">
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="<?php echo base_url('C_beda_nama') ?>" class="btn btn-danger">Batal</a>
