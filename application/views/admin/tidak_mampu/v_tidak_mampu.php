...
<style type="text/css">
	...
	<table style="width: 100%;" id="tbl">
		<tr id="font11">
			<td style="text-align: center;">
				<u>SURAT KETERANGAN TIDAK MAMPU</u></h6>
			</td>
		</tr>
		<tr id="font11">
			<td style="text-align: center;">
	...
	<table style="width: 100%" id="tbl">
		...
		<tr>
			...
			<td>Alamat</td>
			<td> : </td>
			<td><?php echo $data_penduduk->fullalamat ?></td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Benar-benar warga penduduk Desa Bulusari Kecamatan Kalipuro Kabupaten Banyuwangi, yang sampai saat ini masih berdomisili/bertempat tinggal dialamat tersebut diatas, dan yang bersangkutan menurut pengamatan benar-benar keluarga prasejahterah/ Ekonominya Kurang Mampu.</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Surat keterangan ini diberikan sebagai <?php echo $data_penduduk->tujuan; ?>.</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan ini dibuat dengan sebenarnya dan diberikan agar dapat dipergunakan sebagaimana mestinya, bagi yang berkepentingan untuk periksa.</td>
		</tr>
	</table>
	<style type="text/css">
   ...
   <table style="width: 100%;">
   	<tr>
   		...
   		<td style="width: 50%; text-align: center;">
			...
			NAHRAWI
			<br>
			<div style="font-size: 8pt">Pengatur<br>
			Nip. 198001162009061001
			</div>
   		</td>
