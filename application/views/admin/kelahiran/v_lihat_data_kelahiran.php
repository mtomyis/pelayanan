                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <p> <?php echo $data_penduduk->di ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Anak Ke</label>

                      <p> <?php echo $data_penduduk->anak_ke ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Jenis Kelamin</label>

                      <p> <?php echo $data_penduduk->jenis_kelamink ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Anak</label>

                      <p> <?php echo $data_penduduk->nama_anak ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Ibu</label>

                      <p> <?php echo $data_penduduk->nama_ibuk_lahir ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Istri Dari</label>

                      <p> <?php echo $data_penduduk->istri_dari ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Alamat</label>

                      <p> <?php echo $data_penduduk->alamat ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Pelapor</label>

                      <p> <?php echo $data_penduduk->nama_pelapor ?>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama </label>
                      <p> <?php echo $data_penduduk->nama_penduduk ?>
