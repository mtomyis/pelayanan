...
<style type="text/css">
	...
	<table style="width: 100%;" id="tbl">
		<tr id="font11">
			<td style="text-align: center;">
				<u>SURAT PERNYATAAN PENGHASILAN</u></h6>
			</td>
		</tr>
		<tr id="font11">
			<td style="text-align: center;">
	...
	<table>
		<tr>
			<td>Bahwa yang bertanda tangan dibawah ini :</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>Menyatakan bahwa penghasilan kami selama sebulan Rp. <?= $data_penduduk->penghasilan_sebulan ?>,- .</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>Surat keterangan ini kami buat sebagai <?= $data_penduduk->maksud_pembuatan ?>.</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat ini kami  buat dengan sebenarnya berdasarkan keterangan yang bersangkutan dan agar dapat dipergunakan sebagaimana mestinya.</td>
		</tr>
	</table>
	<style type="text/css">
   ...
   <table style="width: 100%;">
   	<tr>
   		...
   		<td style="width: 50%; text-align: center;">
			Bulusari, <?php echo $data_penduduk->tanggal ?>
			<br>
			Yang Menyatakan
			<br>
			<br>
			...
			<br>
			<br>
			<?php echo $data_penduduk->nama_penduduk ?>
   		</td>
   	</tr>
   </table>
