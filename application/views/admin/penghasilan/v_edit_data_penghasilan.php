      ...
      <div class="row">
        ...
        <!-- general form elements -->
            <div class="card card-primary">
              <!-- form start -->
              <form role="form" action="<?php echo base_url('C_penghasilan/simpanedit') ?>" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">NIK</label>
                    <input name="dataid_penghasilan" type="hidden" class="form-control" id="exampleInputPassword1" value="<?php echo $data_penduduk->id_penghasilan ?>" >
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Penghasilan Sebulan</label>
                    <input name="penghasilansebulan" type="text" class="form-control" id="exampleInputPassword1" placeholder="Penghasilan Sebulan" required value="<?php echo $data_penduduk->penghasilan_sebulan ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Maksud Pembuatan</label>
                    <input name="maksudpembuatan" type="text" class="form-control" id="exampleInputPassword1" placeholder="Maksud Pembuatan" required value="<?php echo $data_penduduk->maksud_pembuatan ?>">
                  </div>                  
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  ...
                  <a href="<?php echo base_url('C_penghasilan') ?>" class="btn btn-danger">Batal</a>
