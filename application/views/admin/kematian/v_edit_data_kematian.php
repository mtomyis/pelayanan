      ...
      <div class="row">
        ...
        <!-- general form elements -->
            <div class="card card-primary">
              <!-- form start -->
              <form role="form" action="<?php echo base_url('C_kematian/simpanedit') ?>" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">NIK</label>
                    <input name="dataid_kematian" type="hidden" class="form-control" id="exampleInputPassword1" value="<?php echo $data_penduduk->id_kematian ?>" >
                  ...
                  <div class="form-group">
                    ...
                    <input name="tanggal" type="date" class="form-control" id="exampleInputPassword1" placeholder="Tanggal" required value="<?php echo $data_penduduk->tanggal ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Sebab</label>
                    <input name="sebab" type="text" class="form-control" id="exampleInputPassword1" placeholder="Sebab" required value="<?php echo $data_penduduk->sebab ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Maksud Pembuatan</label>
                    <input name="maksudpembuatan" type="text" class="form-control" id="exampleInputPassword1" placeholder="Maksu Pembuatan" required value="<?php echo $data_penduduk->maksud_pembuatan ?>">
                  </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  ...
                  <a href="<?php echo base_url('C_kematian') ?>" class="btn btn-danger">Batal</a>
