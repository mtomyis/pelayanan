...
<style type="text/css">
	...
	<table style="width: 100%;" id="tbl">
		<tr id="font11">
			<td style="text-align: center;">
				<u>SURAT KETERANGAN KEMATIAN</u></h6>
			</td>
		</tr>
		<tr id="font11">
			<td style="text-align: center;">
	...
	<table style="width: 100%" id="tbl">
		...
		<tr>
			...
			<td>
			<?php
			// $tanggal = new DateTime($data_penduduk->tgl_lahir);

			// // tanggal hari ini
			// $today = new DateTime($data_penduduk->tanggal);
	...
	<table style="width: 100%" id="tbl">
		<tr>
			...
			<td style="width: 1%;"> : </td>
			<td style="width: 69%;"><strong><?php echo $data_penduduk->hari ?></strong></td></tr>
		<tr>
			<td>Tanggal</td>
			<td> : </td>
			<td><?php echo $data_penduduk->tanggal ?></td>
		</tr><tr>
			<td>Sebab kematian</td>
			<td> : </td>
			<td><?php echo $data_penduduk->sebab ?></td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Surat keterangan ini diberikan sebagai persyaratan untuk <?= $data_penduduk->maksud_pembuatan ?>.</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan ini dibuat berdasarkan keterangan dari Keluarga yang bersangkutan dan diberikan agar dapat dipergunakan sebagaimana mestinya.</td>
		</tr>
	</table>
