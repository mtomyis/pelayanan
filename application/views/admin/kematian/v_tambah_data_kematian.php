      ...
      <div class="row">
        ...
        <!-- general form elements -->
            <div class="card card-primary">
              <!-- form start -->
              <form role="form" action="<?php echo base_url('C_kematian/simpan') ?>" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="sebab" type="text" class="form-control" id="exampleInputPassword1" placeholder="Sebab" required>
                  </div>
                  <div class="form-group">
