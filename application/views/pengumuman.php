...
<body>
  ...
  <div class="container">
    ...
    <h3 style="text-align: center;font-family: oswald;">Desa Bulusari</h3>
    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner" style="width: 400px; height: 250px; position: center">
    <div class="carousel-item active" data-interval="10000">
      <img src="assets/gambar/gambar1.jpg" class="d-block w-100" alt="..." width="50" height="550">
    </div>
    <div class="carousel-item" data-interval="2000">
      <img src="assets/gambar/gambar2.jpg" class="d-block w-100" alt="..." width="50" height="550"> 
    </div>
    <div class="carousel-item">
      <img src="assets/gambar/gambar3.jpg" class="d-block w-100" alt="..." width="50" height="550">
    </div>
    <div class="carousel-item">
      <img src="assets/gambar/gambar4.jpg" class="d-block w-100" alt="..." width="50" height="550">
    </div>
  </div>
    <h6 style="text-align: justify; line-height: 20px;font-family: oswald;">Desa Bulusari terletak di kaki Pegunungan Ijen, wilayahnya terdiri dari pemukiman penduduk, lahan pertanian dan perkebunan. Pemukiman warga dapat ditemui di Dusun Bulupayung, Kopensere, dan Plampang. Tipikal pemukiman warga disini adalah rumah khas perkebunan, dimana disekeliling rumah warga banyak ditanami kopi dan sedikit cengkeh. Sedangkan lahan pertaniannya ditanami padi, ketela pohon, kelapa dan buah-buahan dalam jumlah luas lahan yang lebih kecil dibanding perkebunannya. Jalanan desa ini bercabang cabang dan berekskalasi dari ketinggian rendah ke tinggi, sehingga banyak jalan tanjakan melewati rumah warga maupun tepi bukit. Hingga tahun 2015, keadaan jalan desa rusak berat, karena terdiri dari material jalanan aspal yang tinggal batunya saja. Sejak tahun 2015, mulai diadakan perbaikan jalan dari Bulupayung hingga Krajan dan akan berlanjut hingga semua dusun terhubung dengan jalanan yang baik. Mayoritas penduduk Desa Bulusari adalah warga Osing dan berbahasa Osing. Ada juga sebagian warga Suku Madura. Sebagian besar penduduknya bekerja di sektor pertanian dan perkebunan</h6>
  </div>
  </div>
  <!-- penutup isi -->
