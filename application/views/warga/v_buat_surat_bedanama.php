    ...
    <div class="card-body">
      ...
      <form action="<?php echo base_url('C_buat_surat/request_surat') ?>" method="POST"> 
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="ktp" value="<?= $datanoktp ?>" aria-describedby="emailHelp" name="datanoktp" required>
        ...
        <div class="form-group">
          <label for="pilihsurat">Jenis Surat</label>
            <select class="form-control" id="pilihsurat" name="surat">
              <option>Pilih Surat</option>
              <option selected value="bedanama">Surat Keterangan Beda Nama</option>
            </select>
          </form>
        </div>
        ...
        <div class="bedanama box">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="namalama" value="<?= $namalama->nama_penduduk ?>" name="datanamalama">
          </div>
          <div class="form-group">
